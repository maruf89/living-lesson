...
Build and customize a wide range of forms: order forms, registration forms, surveys, quizzes and more. No add-ons and no coding skills required.

== Description ==

> Get more superpowers for your forms and surveys by using CaptainForm: a time-saving tool with great functionality and no add-ons. Create engaging forms very fast due to the drag & drop interface, enjoy a multitude of 3rd party apps, stellar customer support and advanced security. You can choose from a wide diversity of forms such as contact, event registration, donation, feedback, order forms and more. Building and customizing them requires no coding skills. Over 30 simple field types are available such as: name, email, checkboxes, radio buttons, phone numbers, as well as advanced fields: multiple file upload, digital signature, Google maps, social buttons, terms of service, Likert scale, password, page break and more. When you create a form, there are two possibilities: importing one of our 30 templates or starting with a blank form. All plans include stellar customer support and advanced security.
