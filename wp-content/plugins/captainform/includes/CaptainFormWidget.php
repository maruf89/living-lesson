		...
		function form($instance) {
			...
			if ($response->status == 'ok') {
				...
				<div class="captainform_widget_container">
					...
					<div>
						<select name="<?php echo $this->get_field_name('captainform_form_id'); ?>" class="captainform_widget_select" id="<?php echo $this->get_field_id('captainform_form_id'); ?>">
					...
					?>
					<input type="hidden" name="<?php echo $captainform_lightbox_publish_code_name; ?>" class='cf_generated_code' value="<?php echo $captainform_publish_code_value; ?>" />
				</div>
				<?php
			}
			else {
